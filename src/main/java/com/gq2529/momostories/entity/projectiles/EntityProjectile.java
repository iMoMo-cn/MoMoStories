package com.gq2529.momostories.entity.projectiles;
...
public class EntityProjectile extends Entity implements IProjectile {
    ...
    protected EntityProjectile(World worldIn)
    {
        super(worldIn);
    ...
    protected EntityProjectile(World worldIn, ProjectileArgs args) {
        super(worldIn);
        this.args = args;
...
//    public EntityProjectile(World worldIn, ProjectileArgs args, double x, double y, double z, double accelX, double accelY, double accelZ)
//    {
//        this(worldIn, args);
...
//    }
    ...
    public EntityProjectile(World worldIn, ProjectileArgs args, EntityLivingBase shooter, double accelX, double accelY, double accelZ, float acceleration)
    {
        this(worldIn, args);
    ...
    public EntityProjectile(World worldIn, ProjectileArgs args, EntityLivingBase shooter, double accelX, double accelY, double accelZ)
    {
...
//    }
    ...
    /**
     * Called when this EntityProjectile hits a blockBush or entity.
     */
